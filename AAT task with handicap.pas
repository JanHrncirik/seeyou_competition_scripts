...
begin
  ...
  Info1 := 'Maximum Points: '+IntToStr(Round(Pm))+', Dm: '+IntToStr(Round(Dm/1000))+' km, D0: '+IntToStr(Round(D0/1000))+' km, D1: '+IntToStr(Round(D1/1000))+' km, T0: '+FormatFloat('0.000',T0/3600)+' h, n1: '+FormatFloat('0.',n1);
