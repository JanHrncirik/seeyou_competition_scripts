Program AAT_task_with_handicap_Alternative_Scoring;
// Version 1.00 Date November 12, 2022 by Jan Hrncirik
...
//D, D1, H, Dh, Dg, M, T, Dc, Pd, V, Vh, Pv, S : double; CORRECTED; DELETED Dg, Dc, ; ADDED Sp, S
  D, D1, H, Dh, M, T, Pd, V, Vh, Pv, Sp, S : double;
...
begin
  ...
  if D1 <> 0 then PmaxDistance := 1250 * (D0/D1)-250;
